...
export default function Inventari() {
  ...
  async function carregar() {
    setCarregant(true);
    try {
      const dadesProductes = await llistarProductes();
      ...
      setError("No s'ha pogut carregar l'inventari");
    } finally {
      setCarregant(false);
    }
  }
  ...
  if (carregant) return <p style={{ padding: 24, fontFamily: 'sans-serif' }}>Carregant inventari...</p>;
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', padding: 24 }}>
      ...
      {productes.length === 0 && <p style={{ color: '#888' }}>No hi ha productes per mostrar.</p>}
